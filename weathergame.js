    ...
    winnercalculator: function (x, y) {
        ...
        if (radio === "HIGH TEMPEARATURE GAME") {
          ...
          let img1=document.querySelector("#winnerimage1")
                img1.src="https://pngimg.com/uploads/minions/small/minions_PNG35.png"
                ...
                img2.src="https://pngimg.com/uploads/minions/small/minions_PNG84.png"
            ...
            if (x > y) {
                ...
                winner.innerText = "draw"
                let img1=document.querySelector("#winnerimage")
                img1.src="https://pngimg.com/uploads/minions/small/minions_PNG86.png"
                img1.id="winnerimage"
                imagediv1.appendChild(img1)
            } else {
                winner.innerText = "winner is player 1"
...
x.addEventListener("click",()=>{
    ...
    let imagediv1=document.querySelector("#imagediv1")
                ...
                img1.id="winnerimage1"
                imagediv1.appendChild(img1)}else{
                    let img1=document.querySelector("#winnerimage1")
                    img1.src=`https://pngimg.com/uploads/minions/small/minions_PNG${imageno[randomnum]}.png`
                    img1.id="winnerimage1"
                    imagediv1.appendChild(img1)
...
y.addEventListener("click",()=>{
   countimage2++
    ...
    img2.id="winnerimage2"
    imagediv2.appendChild(img2)}else{
        let img2=document.querySelector("#winnerimage2")
